...
/**
 * <p>
 *  {@link Integer}형태로 {@link java.sql.ResultSet}에서 데이터를 fetch하여 반환한다.<br>
 * </p>
 *
 * @author 최승일
 ...
 * @since 4.0
 */
public class IntColumnReader implements ColumnReader {
	/**
	 * {@link Integer}형태로 {@link java.sql.ResultSet}에서 데이터를 fetch하여 <br>
	 *  return 한다.
	...
	private Object parse(BigDecimal value) {
        ...
        if (value == null) {
            ...
            retObj = Integer.valueOf(value.intValue());
        }
		return retObj;
	}
}
