...
/**
 * <p>
 *  {@link Float}형태로 {@link java.sql.ResultSet}에서 데이터를 fetch하여 반환한다.<br>
 * </p>
 *
 */
public class RealColumnReader implements ColumnReader {
	/**
	 * {@link Float}형태로 {@link java.sql.ResultSet}에서 데이터를 fetch하여 <br>
	 *  return 한다.
	...
	private Object parse(BigDecimal value) {
        ...
        if (value == null) {
            ...
            retObj = Float.valueOf(value.floatValue());
        }
		return retObj;
	}
}